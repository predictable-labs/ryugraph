...
bool CaseExpressionEvaluator::selectInternal(SelectionVector& selVector) {
    evaluate();
    RYU_ASSERT(resultVector->state->getSelVector().getSelSize() != 0);
    RYU_ASSERT(selVector.getSelSize() != 0);
    RYU_ASSERT(resultVector->state->getSelVector().getSelSize() == selVector.getSelSize());
